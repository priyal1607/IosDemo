...
//
//  Created by Dhruv Patel on 30/04/21.
//
...
//                    self.direction = direction == .toLeft ? .toRight : .toLeft
//                }
            }
        }
...
internal extension UIViewController {
    ...
    ///   - frame: frame
    /// - Returns: instance
    static fileprivate func newController(withView view: UIView, frame: CGRect) -> UIViewController {
