...
@objc public class TagCellLayout: UICollectionViewFlowLayout {
    ...
    @objc public weak var delegate: TagCellLayoutDelegate?
    
    //MARK: - Init Methods
    @objc public init(alignment: LayoutAlignment = .left, delegate: TagCellLayoutDelegate?) {
