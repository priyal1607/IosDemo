...
class khelSathiMidDelegate : NSObject {
...
extension khelSathiMidDelegate: UICollectionViewDelegate {
...
extension khelSathiMidDelegate: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configCalData(data: arrSource[indexPath.row] , index : indexPath.row)
        return cell
    }
}

extension khelSathiMidDelegate: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: IS_IPAD ? (SCREEN_WIDTH - (IPAD_MARGIN)) : ((SCREEN_WIDTH/4)-18) , height: ((SCREEN_WIDTH/2)-70)/1.21)
    }
