...
class khelSathiPagerDelegate : NSObject {
...
extension khelSathiPagerDelegate: UICollectionViewDelegate {
...
extension khelSathiPagerDelegate: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configPager(data: arrSource[indexPath.row] , index : indexPath.row)
        return cell
    }
}

extension khelSathiPagerDelegate: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: IS_IPAD ? (SCREEN_WIDTH - (IPAD_MARGIN)) : ((SCREEN_WIDTH)) , height: ((SCREEN_WIDTH/2)-23)/1.21)
    }
