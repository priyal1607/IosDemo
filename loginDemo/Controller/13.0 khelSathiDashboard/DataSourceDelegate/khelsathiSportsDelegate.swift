...
class khelsathiSportsDelegate : NSObject {
...
extension khelsathiSportsDelegate: UICollectionViewDelegate {
...
extension khelsathiSportsDelegate: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configureSportsdata(data: arrSource[indexPath.row] , index : indexPath.row)
        return cell
    }
}

extension khelsathiSportsDelegate: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: IS_IPAD ? (SCREEN_WIDTH - (IPAD_MARGIN)) : ((SCREEN_WIDTH/4)) , height: ((SCREEN_WIDTH/2)-70)/1.21)
    }
