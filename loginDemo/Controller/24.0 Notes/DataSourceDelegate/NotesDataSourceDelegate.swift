...
class NotesDataSourceDelegate : NSObject {
...
extension NotesDataSourceDelegate: UICollectionViewDelegate {
...
extension NotesDataSourceDelegate: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configureCellNotes(index: indexPath.row)
        cell.addShadow()
        return cell
    }
}

extension NotesDataSourceDelegate: UICollectionViewDelegateFlowLayout {
